 ...
 * @author ASUS
 */
public class Afiliator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        afiliatorTbl = new javax.swing.JTable();
        ...
        navAfiliator.setBackground(new java.awt.Color(0, 102, 153));
        ...
        jLabel1.setText("Nama Afiliator");

        jLabel2.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        jLabel2.setText("ID Afiliator");

        jLabel3.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        jLabel3.setText("No. LAI Terasosiasi");
        ...
        afiliatorTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "ID Afiliator", "Nama Afiliator", "ID Klien Terasosiasi", "No. LAI"
            }
        ) {
        ...
        afiliatorTbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                afiliatorTblMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(afiliatorTbl);
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        try {
            ...
            pst.setString(2, idKlien);
            pst.setString(3, noLai);
            pst.setString(4, idTerasosiasi);
            pst.execute();
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try {
            pst = conn.prepareStatement(sqlQuery);
            pst.setString(1, idTerasosiasi);
            pst.setString(2, namaTerasosiasi);
            pst.setString(3, idKlien);
            pst.setString(4, noLai);
    ...
    private void searchTxtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTxtKeyTyped
        ...
        String sqlQuery = "SELECT * FROM afiliator WHERE nama_afiliator LIKE '%" + key + "%'";
    ...
    private void afiliatorTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_afiliatorTblMouseClicked
        // TODO add your handling code here:
        int r = afiliatorTbl.getSelectedRow();
        String click = afiliatorTbl.getModel().getValueAt(r, 0).toString();
        String sqlQuery = "SELECT * FROM afiliator WHERE ID_afiliator='" + click + "'";
    ...
    private javax.swing.JTextField laiTerasosiasiTxt;
